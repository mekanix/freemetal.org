...
const Layout = React.createClass({
  ...
  componentWillMount() {
    ...
    this.audio.src = 'http://freemetal.org:8000/metal.ogg';
  },
  ...
  render() {
    ...
    return (
      <div>
        ...
        <AppBar
          title={<span style={styles.title}>Free Metal</span>}
        ...
        <div style={styles.footer}>
          <FloatingActionButton onTouchTap={this.handlePlay} mini>
            {this.state.paused ? <PlayArrow /> : <Stop />}
          </FloatingActionButton>
          <LinearProgress mode="determinate" />
          <FloatingActionButton
            style={styles.player.volume}
            onTouchTap={this.handleVolume}
            mini
          >
            <Volume />
          </FloatingActionButton>
          <div style={styles.player.title}>
            Artist - Song
          </div>
